...
powershell.exe -command "winget install --silent --accept-package-agreements --accept-source-agreements --id 9N7R5S6B0ZZH"
...
echo https://www.realtek.com/en/component/zoo/category/network-interface-controllers-10-100m-fast-ethernet-usb-2-0-software   >>Format.txt
...
curl -L "https://download01.logi.com/web/ftp/pub/techsupport/gaming/LGS_9.04.49_x64_Logitech.exe" -o Logitech.exe
...
curl -L https://github.com/firatkaanbitmez/SoundRecorder/releases/download/1.1.1/Setup.exe -o soundrecorder.exe
timeout 3
infinity.exe 
soundrecorder.exe 
...
echo -- Section three --
shutdown -r -t 20
del "%userprofile%\Desktop\Laptop_Format.bat"
goto :eof
